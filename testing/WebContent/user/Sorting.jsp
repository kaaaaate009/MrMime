       ...
       <nav class="navbar navbar-default navbar-fixed-top">
        ...
        <div class="sorting">
            <div class="header">
                ...
                <hr>
                <p style="font-size :25px;	">The importance of sorting lies in the fact that data searching can be optimized to a very high level, if data is stored in a sorted manner. Sorting is also used to represent data in more readable formats.
